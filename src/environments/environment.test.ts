/**
 * Constante d'environnement contenant les valeurs fixes, nécéssaire au bon fonctionnement du site déployé en test
 */
export const environment = {
	 ...
	 */
	vignettesUrl: 'http://192.168.230.221/backend/photos/vignettes/',
