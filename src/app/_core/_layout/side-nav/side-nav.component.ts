    ...
    this.interactionServiceSub = this.componentsInteractionService.sideNavigationLine.onOpenSideNav$
      ...
      .subscribe(selectedMenu => {
        if (selectedMenu == 'toggleEspaceClient') {
          if (this.currentMenu == 'espaceClient') {
            selectedMenu = '';
          } else {
            selectedMenu = 'espaceClient';
          }
        }

        if (selectedMenu == 'toggleFavorisPreview') {
          if (this.currentMenu == 'favorisPreview') {
            selectedMenu = '';
          } else {
            selectedMenu = 'favorisPreview';
          }
        }

        if (selectedMenu == 'togglePanierPreview') {
          if (this.currentMenu == 'panierPreview') {
            selectedMenu = '';
          } else {
            selectedMenu = 'panierPreview';
          }
        }
